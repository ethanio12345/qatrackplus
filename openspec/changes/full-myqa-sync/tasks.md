...
## Task 1: Create `myqa_import.py` — Import engine
...
## Task 2: Create `setup_myqa_tests.py` — One-time setup
...
## Task 3: Create `import_myqa.py` management command
...
## Task 4: Wire into `tasks.py` + `apps.py`
...
## Task 5: Consolidate existing matrix import
...
## Task 6: Backfill historical data
